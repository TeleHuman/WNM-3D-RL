    ...
    **kwargs,
    ...
    Args:
        ...
        solution_image: The generated image, as a ``torch.Tensor`` in shape
            ``(C, H, W)`` or ``(N, C, H, W)``.
        ground_truth (str): Ground-truth answer (may be unused by custom rewards).
    ...
    raise NotImplementedError(
        f"No built-in image scorer is configured for {data_source=}; "
        "provide reward.custom_reward_function.path and .name."
    )
