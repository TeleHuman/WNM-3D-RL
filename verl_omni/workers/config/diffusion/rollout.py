...
class DiffusionRolloutAlgoConfig(BaseConfig):
    ...
    sde_type: str = "sde"
    # DanceGRPO control variate: samples in one prompt group share only the
    # initial latent noise. Their transition/Brownian RNG streams stay unique.
    init_same_noise: bool = False
    # WAM action transitions default to the visual SDE settings when unset.
    action_noise_level: Optional[float] = None
    action_sde_type: Optional[str] = None
